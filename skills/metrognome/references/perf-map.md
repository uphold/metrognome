...
Static, device-free scan of a RN repo → interactive 3D graph + Top-3 worst performance offenders. Nodes = source modules; edges = imports. Node **size = perf debt**, **color = severity**. Pipeline:
